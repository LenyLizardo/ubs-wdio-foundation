...
describe('Login using external account', () => {
  ...
  it('should validate the history of videos and podcasts', async () => {
    Insights.validateHistory();
  });

  it('should validate the history of articles', async () => {
    Insights.validateReadLater();
  })
});
